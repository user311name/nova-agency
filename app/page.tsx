      ...
      ====================================================== */}
        ...
        <div className="container nova-why-container">
          ...
          <div className="nova-why-grid">
            <article className="nova-why-card nova-why-card-featured"><div className="nova-why-card-top"><span>01</span><span>↗</span></div><div className="nova-why-card-content"><h3>Une maquette pour vous projeter.</h3><p>Avant de commencer, vous pouvez visualiser la direction donnée à votre projet.</p></div></article>
            <article className="nova-why-card"><div className="nova-why-card-top"><span>02</span><span>↗</span></div><div className="nova-why-card-content"><h3>On part du besoin, pas d&apos;une formule.</h3><p>Chaque projet commence par votre activité, vos objectifs et vos besoins.</p></div></article>
            <article className="nova-why-card"><div className="nova-why-card-top"><span>03</span><span>↗</span></div><div className="nova-why-card-content"><h3>Votre image ne s&apos;arrête pas au site.</h3><p>Logo, supports imprimés, véhicule, réseaux et présence en ligne peuvent fonctionner ensemble.</p></div></article>
            <article className="nova-why-card"><div className="nova-why-card-top"><span>04</span><span>↗</span></div><div className="nova-why-card-content"><h3>Un seul fil conducteur pour votre projet.</h3><p>Une identité cohérente sur tous vos supports.</p></div></article>
            <article className="nova-why-card"><div className="nova-why-card-top"><span>05</span><span>↗</span></div><div className="nova-why-card-content"><h3>L&apos;IA comme accélérateur, pas comme identité.</h3><p>Elle peut nous aider à explorer et produire plus vite, mais votre image reste pensée pour votre activité.</p></div></article>
            <article className="nova-why-card"><div className="nova-why-card-top"><span>06</span><span>↗</span></div><div className="nova-why-card-content"><h3>Une présence qui peut continuer d&apos;évoluer.</h3><p>Votre site et votre univers peuvent évoluer avec votre entreprise.</p></div></article>
          </div>
