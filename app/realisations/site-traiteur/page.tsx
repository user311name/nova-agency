...
const images = [
  "/projets/Site-traiteur.png",
  "/projets/Site-traiteur1.png",
  "/projets/Site-traiteur2.png",
];
...
export default function SiteTraiteurPage() {
    ...
    <main className="project-page">
      ...
      <section className="project-hero" aria-labelledby="project-title">
        <div className="project-hero-meta">
          ...
          <span>RESTAURATION / TRAITEUR</span>
          <span>2026</span>
        </div>
        ...
        <div className="project-hero-title">
          ...
          <h1 id="project-title">
            TRAITEUR
            <span>Le goût du détail.</span>
          </h1>

          <p className="project-description">
            Un concept digital imaginé pour présenter une activité de
            traiteur avec une image élégante, chaleureuse et contemporaine.
          </p>
        </div>
        ...
        <div className="project-hero-footer">
          ...
          <span>03 — PRÉSENTATION</span>
        </div>
      </section>

      <section
        className="project-feature"
        aria-label="Présentation visuelle du projet Traiteur"
      >
        <button
          type="button"
          className="feature-image"
          onClick={() => setSelectedImage(images[0])}
          aria-label="Agrandir la première image du projet Traiteur"
        >
          <Image
            src={images[0]}
            alt="Traiteur — aperçu principal du projet"
            fill
            priority
      ...
      <section className="project-intro">
        ...
        <div className="project-intro-content">
          ...
          <h2>
            Une expérience qui
            <span> donne envie.</span>
          </h2>

          <p>
            Le projet repose sur une direction artistique élégante et
            accessible. L’objectif était de mettre en valeur l’univers
            culinaire, les prestations et l’image du projet tout en gardant
      ...
      <section className="project-gallery">
        <div className="gallery-heading">
          <div>
            ...
            <h2>Chaque écran valorise l&apos;univers du projet.</h2>
          </div>
        ...
        <div className="gallery-grid">
          <button
            ...
            aria-label="Agrandir la deuxième image du projet Traiteur"
          >
            <Image
              src={images[1]}
              alt="Traiteur — aperçu deuxième écran"
              fill
          ...
          <button
            ...
            aria-label="Agrandir la troisième image du projet Traiteur"
          >
            <Image
              src={images[2]}
              alt="Traiteur — aperçu troisième écran"
              fill
      ...
      <section className="project-case-study">
        <div className="case-study-heading">
          <div>
            ...
            <h2>Une image soignée. Une expérience cohérente.</h2>
          </div>
        ...
        <div className="case-study-grid">
          <article>
            ...
            <h3>Une identité qui donne envie.</h3>

            <p>
              Une direction visuelle pensée pour mettre en avant l’univers
              culinaire et créer une première impression élégante.
            </p>
          </article>
          ...
          <article>
            ...
            <h3>Présenter l&apos;offre simplement.</h3>

            <p>
              Le site organise les informations importantes afin de permettre
              au visiteur de comprendre rapidement l’univers et les
          ...
          <article>
            ...
            <h3>Une expérience fluide sur chaque écran.</h3>

            <p>
              Une interface claire, une hiérarchie visuelle maîtrisée et une
              expérience pensée aussi bien pour desktop que pour mobile.
            </p>
          </article>
        </div>
      </section>
      ...
      {selectedImage && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Aperçu de l'image du projet Traiteur"
        ...
        >
          ...
          >
            <Image
              src={selectedImage}
              alt="Traiteur — aperçu agrandi"
              fill
              sizes="100vw"
            />
          </div>

          <span className="lightbox-label">TRAITEUR / PREVIEW</span>
        </div>
      )}
    </main>
  );
